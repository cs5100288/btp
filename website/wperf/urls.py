...
urlpatterns = patterns('wperf.views',
                      ...
                      (r'addobservation_adcomparison/id/(\d+)', 'addobservation_adcomparison'),
                      ('test', 'test'),
                      (r'pcap/list', 'pcap_list'),
                      (r'pcap/upload', 'pcap_upload'),
                      (r'pcap/obs_list', 'obs_pcap_list'),
                      (r'pcap/obs_upload', 'obs_pcap_upload'),
                      (r'pcap/ads_vs_no_ads_list', 'ads_vs_no_ads_pcap_list'),
                      (r'pcap/ads_vs_no_ads_summary', 'ads_vs_no_ads_summary'),
                      (r'pcap/ads_vs_no_ads_upload', 'ads_vs_no_ads_pcap_upload'),
                      ...
                      (r'pcap/ff_analyze', 'ff_analyze'),
                      (r'pcap/obs_analyze_pca', 'obs_analyze_pca'),
                      (r'pcap/obs_analyze_pca_old', 'obs_analyze_pca'),
                      (r'pcap/ads_vs_no_ads_analyze/(.*)', 'ads_vs_no_ads'),
                      (r'pcap/ads_vs_no_ads_analyze_old/(.*)', 'ads_vs_no_ads'),
